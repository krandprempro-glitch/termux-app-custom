...
import com.linux.terminal.shared.termux.terminal.io.BellHandler;
import com.linux.terminal.shared.logger.Logger;
import com.linux.terminal.terminal.TerminalColors;
import com.linux.terminal.terminal.TerminalSession;
import com.linux.terminal.terminal.TerminalSessionClient;
import com.linux.terminal.terminal.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                mBellSoundId = mBellSoundPool.load(mActivity, com.linux.terminal.shared.R.raw.bell, 1);
            } catch (Exception e){
                // Catch java.lang.RuntimeException: Unable to resume activity {com.linux.terminal/com.linux.terminal.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
